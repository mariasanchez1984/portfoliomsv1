<!-- Examen práctico. María Sánchez Vielba -->
...
<html>
    <head>
        ...
        <title>ContenedorFlex</title>
    </head>
    <body>
        <header>
            <p>Flex box</p>
        </header>
            <div id="contenedor"> <!-- Contenedor Flex Principal -->
                <div class="elemento elemento1">
                    <img src="img/madrid-cerro-tio-pio.jpg" alt=""/>
                ...
                </div><div class="elemento elemento1">
                    <img src="img/madrid-cerro-tio-pio.jpg" alt=""/>
                    <p>Lorem Ipsum is simply dummy text of the printing and
                        typesetting industry. Lorem Ipsum has been the industry's
                        standard dummy text ever since the 1500s, when an unknown
